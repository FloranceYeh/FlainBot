...
class FrontendStaticTests(unittest.TestCase):
    def test_planner_page_references_assets_and_nodes(self):
        ...
        self.assertIn("data-route=\"personas\"", html)
        ...
        self.assertNotIn("<details", html.split("<aside id=\"result-panel\"", 1)[1])
        ...
        self.assertIn("apiUrl(\"/api/personas\")", js)
        self.assertIn("loadPersonas", js)
        self.assertIn("savePersonas", js)
        self.assertIn("renderPersonas", js)
        self.assertIn("renderPersonaSelect", js)
        ...
        self.assertIn("packageFilterOptionsEl", js)
        self.assertIn("inputTypeFilterOptionsEl", js)
        self.assertIn("outputTypeFilterOptionsEl", js)
        self.assertIn("filterNodeCatalog", js)
        self.assertIn("renderNodeFilters", js)
        self.assertIn("updateNodeFilterSummary", js)
        self.assertIn("selectedFilterValues", js)
        ...
        self.assertIn("nodePreviewPopoverEl", js)
