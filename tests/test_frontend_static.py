...
class FrontendStaticTests(unittest.TestCase):
    ...
    def test_chat_view_is_in_single_index_shell(self):
        ...
        self.assertIn("class=\"trace-size-control\"", html)
        self.assertIn("traceSize: \"medium\"", js)
        self.assertIn("traceSizeOptions", js)
        self.assertIn(":class=\"`trace-size-${traceSize}`\"", html)
        ...
        self.assertIn(".trace-panel.trace-size-small pre", css)
        self.assertIn(".trace-panel.trace-size-medium pre", css)
        self.assertIn(".trace-panel.trace-size-large pre", css)
