...
class FrontendStaticTests(unittest.TestCase):
    ...
    def test_logs_view_is_in_single_index_shell(self):
        ...
        self.assertIn("class=\"run-log-group\"", html)
        self.assertIn("class=\"run-log-events\"", html)
        self.assertIn("class=\"log-entry\"", html)
        self.assertIn("class=\"log-level\"", html)
        self.assertIn("class=\"log-source\"", html)
        self.assertIn("class=\"log-event\"", html)
        self.assertIn("class=\"log-node\"", html)
        self.assertIn("log.details?.event", html)
        self.assertIn("log.details?.node_id", html)
        ...
        self.assertIn("logStreamUrl", js)
        self.assertIn("new EventSource(logStreamUrl())", js)
        self.assertIn("groupLogsByRun", js)
        self.assertIn("useLogs", js)
        self.assertIn("\"/api/logs\"", js)
        self.assertIn("\"/api/logs/stream\"", js)
        self.assertIn("fetch(apiUrl(\"/api/logs\"), {method: \"DELETE\"})", js)
        self.assertIn("startLogStream", js)
        self.assertIn("clearLogEntries", js)
        self.assertIn(".logs-shell", css)
        self.assertIn(".logs-toolbar", css)
        self.assertIn(".run-log-group", css)
        self.assertIn(".run-log-events", css)
        self.assertIn(".log-entry.level-error", css)
        self.assertIn(".log-event", css)
        self.assertIn(".log-node", css)
